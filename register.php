...
background: linear-gradient(45deg, #f39c12, #e67e22); /* تدرج لوني دافئ وجذاب للخلفية */
display: flex;
...
if(isset($message)){
    foreach($message as $message){
        $class = (strpos($message, 'غير متطابقتين') !== false || strpos($message, 'مسجل بالفعل') !== false) ? 'error' : '';
